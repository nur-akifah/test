                ...
                <div class="container-fluid position-sticky" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Part Data</li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <br>
                                    <h5 class="m-0 font-weight-bold text-primary">Part Data</h5><br><br>
                                </div><br>
                            ...
                            <!-- === Table dan Pareto === -->
                            <div class="tab">
                                <button class="tablinks" onclick="openCity(event, 'part-data')">Table</button>
                            </div>
    ...
    <!-- <div class="container">
                <form id="redirectForm" action="#" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="material12nc" class="col-sm-2 col-form-label">Insert Tanggal</label>
                        <div class="col-sm-2">
                            <input type="text" name="query" class="form-control" placeholder="">
                        </div>
                        <div class="col-sm-2">
                            <input type="submit" value="Search" id="submitButton" class="btn btn-primary mb-2" name="">
                        </div>
                    </div>
                </form>
            </div> -->
