                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <br>
                                    <h5 class="m-0 font-weight-bold text-primary">Welcome!</h5><br><br>
                                </div><br>
                                ...
                                <div class="container mt-3">
                                    <div class="row mb-1">
                                        <!-- Cell/RA -->
                                        <a href="gl5.php" class="col-md-3 mb-2" style="text-decoration:none;">
                                            <div class="card h-80">
                                                <div class="card-body">
                                                    <center><img src="./Images/bullseye.png" style="max-width: 35px;"></center><br>
                                                    <div class="font-weight-bold text-uppercase text-center text-dark">Guard Line 5</div>
                                                </div>
                                            </div>
                                        </a>

                                        <a href="gl6.php" class="col-md-3 mb-2" style="text-decoration:none;">
                                            <div class="card h-80">
                                                <div class="card-body">
                                                    <center><img src="./Images/bullseye.png" style="max-width: 35px;"></center><br>
                                                    <div class="font-weight-bold text-uppercase text-center text-dark">Guard Line 6</div>
                                                </div>
                                            </div>
                                        </a>

                                        <a href="./Guardline-X/glx.php" class="col-md-3 mb-2" data-target="#selectmir1" style="text-decoration:none;">
                                            <div class="card h-80">
                                                <div class="card-body">
                                                    <center><img src="./Images/bullseye.png" style="max-width: 35px;"></center><br>
                                                    <div class="font-weight-bold text-uppercase text-center text-dark">Guard Line X</div>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <!-- End of Form Order Material -->
                                    <br>
                                    <br>
