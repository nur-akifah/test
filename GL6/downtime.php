                ...
                <div class="container-fluid position-sticky" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Downtime</li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <br>
                                    <h5 class="m-0 font-weight-bold text-primary">Downtime</h5><br><br>
                                </div>
                                <br>
                            ...
                            <div class="tab">
                                ...
                                <button class="tablinks" onclick="openCity(event, 'table-list')">Storingen</button>
                            </div>
