...
$result = sqlsrv_query($conn, "SELECT * FROM dbo.TB_PD_RA100");
if (!$result) {
                                        ...
                                        <div class="form-group row">
                                            <!-- <div class="col-sm-2">
                                                <div class="input-group">
                                                    <button type="button" class="btn btn-secondary" name="hour">Current Hour</button>
                                                </div>
                                            </div> -->
                                            <!-- <div class="col-sm-2">
                                                <div class="btn-group me-2" role="group" aria-label="First group">
                                                    <button type="button" class="btn btn-secondary" name="shift">Current Shift</button>
                                                </div>
                                            </div> -->
                                            <!-- <div class="col-sm-2">
                                                <div class="input-group">
                                            ...
                                            <div class="col-sm-2">
                                                <select class="form-control" aria-label="Default select example" name="cell">
                                    ...
                                    <table class="table align-items-center table-flush table-hover table-striped">
                                        ...
                                        <!-- <tbody>
                                                <tr align="center" id="table">
                                                    ...
                                                    <td><?= $data['Buffer_Index']; ?></td>
                                                    <td><?= $data['Batch_Reel']; ?></td>
                                                    <td><?= $data['Guard_Counter']; ?></td>
                                                </tr>
                                            </tbody> -->
