                ...
                <div class="container-fluid position-sticky" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">RA106 Part Data</li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <br>
                                    <h5 class="m-0 font-weight-bold text-primary">RA106 Part Data</h5><br><br>
                                </div>
                                <br>
                                <div class="container">
                                    <form>
                                    ...
                                    <table class="table align-items-center table-flush table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr align="center" id="table">
                                                ...
                                                <td><?= $data['Vision5_Score'] ?></td>
                                                <td><?= $data['Vision6_Score'] ?></td>
                                                <td><?= $data['ActTemp1'] ?></td>
                                                <td><?= $data['ActTemp2'] ?></td>
                                                <td><?= $data['ActHumidity'] ?></td>
                                                <td><?= $data['Batch_Ink3'] ?></td>
                                                <td><?= $data['Batch_Ink4'] ?></td>
                                                <td><?= $data['Batch_Thinner'] ?></td>
                                            </tr>
                                        </tbody>
