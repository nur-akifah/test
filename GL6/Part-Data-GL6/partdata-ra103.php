                ...
                <div class="container-fluid position-sticky" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">RA103</li>
                        </ol>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <br>
                                    <h5 class="m-0 font-weight-bold text-primary">RA100 Part Data</h5><br><br>
                                </div>
                                <br>
                                <div class="container">
                                    <form>
                                ...
                                <table class="table align-items-center table-flush table-hover table-striped">
                                    ...
                                    <tbody>
                                        <tr align="center" id="table">
                                            ...
                                            <td><?= $data['EndDist_LL'] ?></td>
                                            <td><?= $data['EndDist'] ?></td>
                                            <td><?= $data['EndDist_UL'] ?></td>
                                            <td><?= $data['EndForce_LL'] ?></td>
                                            <td><?= $data['EndForce'] ?></td>
                                            <td><?= $data['EndForce_UL'] ?></td>
                                            <td><?= $data['MaxForce_LL'] ?></td>
                                            <td><?= $data['MaxForce'] ?></td>
                                            <td><?= $data['MaxForce_UL'] ?></td>
                                            <td><?= $data['MaxForceDist_LL'] ?></td>
                                            <td><?= $data['MaxForceDist'] ?></td>
                                            <td><?= $data['MaxForceDist_UL'] ?></td>
                                            <td><?= $data['Batch_Cutter'] ?></td>
                                            <td><?= $data['Batch_Island'] ?></td>
                                            <td><?= $data['Batch_DB'] ?></td>
                                        </tr>
                                    </tbody>
