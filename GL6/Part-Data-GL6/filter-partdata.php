...
?>
    <!-- === SHOW TABLE FROM RA101 DATABASE === -->
    ...
    <table class="table align-items-center table-flush table-hover table-striped">
        ...
        <?php
        $query = sqlsrv_query($conn, "SELECT * FROM dbo.PartDataRA100 WHERE DateTimeOut >= '$start' AND DateTimeOut <= '$end' ");
...
<!-- === SHOW TABLE FROM RA102 DATABASE === -->
<?php
...
<!-- === SHOW TABLE FROM RA103 DATABASE === -->
<?php
...
?>
    ...
    <table class="table align-items-center table-flush table-hover table-striped">
        ...
        <!-- ==== Letakkan Code PHP While Disini === -->
        <?php
        $query = sqlsrv_query($conn, "SELECT * FROM PartDataRA103 WHERE DateTimeOut >= '$start' AND DateTimeOut <= '$end' ");
        while ($row = sqlsrv_fetch_array($query)) {
        ?>
            <!-- Filter DateTime Only -->
...
<!-- === SHOW TABLE FROM RA104 DATABASE === -->
<?php
...
?>
    ...
    <table class="table align-items-center table-flush table-hover table-striped">
        ...
        <!-- ==== Letakkan Code PHP While Disini === -->
        <?php
        $query = sqlsrv_query($conn, "SELECT * FROM PartDataRA104 WHERE DateTimeOut >= '$start' AND DateTimeOut <= '$end' ");
        while ($row = sqlsrv_fetch_array($query)) {
        ?>
            <tbody>
                <tr align="center" id="table">
...
<!-- === SHOW TABLE FROM RA105 DATABASE === -->
<?php
...
?>
    ...
    <table class="table align-items-center table-flush table-hover table-striped">
        ...
        <!-- ==== Letakkan Code PHP While Disini === -->
        <?php
        $query = sqlsrv_query($conn, "SELECT * FROM PartDataRA105 WHERE DateTimeOut >= '$start' AND DateTimeOut <= '$end' ");
        while ($row = sqlsrv_fetch_array($query)) {
        ?>
            <!-- Filter DateTime Only -->
...
<!-- === SHOW TABLE FROM RA106 DATABASE === -->
<?php
...
?>
    ...
    <table class="table align-items-center table-flush table-hover table-striped">
        ...
        <!-- ==== Letakkan Code PHP While Disini === -->
        <?php
        $query = sqlsrv_query($conn, "SELECT * FROM PartDataRA106 WHERE DateTimeOut >= '$start' AND DateTimeOut <= '$end' ");
        while ($row = sqlsrv_fetch_array($query)) {
        ?>
            <!-- Filter DateTime Only -->
...
<!-- === SHOW TABLE FROM RA108 DATABASE === -->
<?php
...
?>
    ...
    <table class="table align-items-center table-flush table-hover table-striped">
        ...
        <!-- ==== Letakkan Code PHP While Disini === -->
        <?php
        $query = sqlsrv_query($conn, "SELECT * FROM PartDataRA108 WHERE DateTimeOut >= '$start' AND DateTimeOut <= '$end' ");
        while ($row = sqlsrv_fetch_array($query)) {
        ?>
            <!-- Filter DateTime Only -->
