                                ...
                                <table class="table align-items-center table-flush table-hover table-striped">
                                    ...
                                    <tbody>
                                        <tr align="center" id="table">
                                            ...
                                            <td><?= $data['Vision1_Score'] ?></td>
                                            <td><?= $data['Vision2_Score'] ?></td>
                                            <td><?= $data['Vision3_Score'] ?></td>
                                            <td><?= $data['Vision4_Score'] ?></td>
                                            <td><?= $data['ActTemp1'] ?></td>
                                            <td><?= $data['ActTemp2'] ?></td>
                                            <td><?= $data['ActHumidity'] ?></td>
                                            <td><?= $data['Batch_Ink1'] ?></td>
                                            <td><?= $data['Batch_Ink2'] ?></td>
                                            <td><?= $data['Batch_Hardener'] ?></td>
