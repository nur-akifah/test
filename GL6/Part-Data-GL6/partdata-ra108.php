                                    ...
                                    <table class="table align-items-center table-flush table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr align="center" id="table">
                                                ...
                                                <td><?= $data['Carrier3_No'] ?></td>
                                                <td><?= $data['Carrier3_Pos'] ?></td>
                                                <td><?= $data['Nest_No'] ?></td>
                                                <td><?= $data['Nest_Pos'] ?></td>
                                                <td><?= $data['OutputStackCode'] ?></td>
                                                <td><?= $data['12NC'] ?></td>
                                                <td><?= $data['DMC'] ?></td>
                                                <td><?= $data['ProcessCode'] ?></td>
                                                <td><?= $data['BufferIndex'] ?></td>
                                                <td><?= $data['VisionResult'] ?></td>
                                                <td><?= $data['Measurement_SilverX_LL'] ?></td>
                                                <td><?= $data['Measurement_SilverX'] ?></td>
                                                <td><?= $data['Measurement_SilverX_UL'] ?></td>
                                                <td><?= $data['Measurement_SilverY_LL'] ?></td>
                                                <td><?= $data['Measurement_SilverY'] ?></td>
                                                <td><?= $data['Measurement_SilverY_UL'] ?></td>
                                                <td><?= $data['Measurement_SilverR_LL'] ?></td>
                                                <td><?= $data['Measurement_SilverR'] ?></td>
                                                <td><?= $data['Measurement_SilverR_UL'] ?></td>
                                                <td><?= $data['Measurement_BlackX_LL'] ?></td>
                                                <td><?= $data['Measurement_BlackX'] ?></td>
                                                <td><?= $data['Measurement_BlackX_UL'] ?></td>
                                                <td><?= $data['Measurement_BlackY_LL'] ?></td>
                                                <td><?= $data['Measurement_BlackY'] ?></td>
                                                <td><?= $data['Measurement_BlackY_UL'] ?></td>
                                                <td><?= $data['Measurement_BlackR_LL'] ?></td>
                                                <td><?= $data['Measurement_BlackR'] ?></td>
                                                <td><?= $data['Measurement_BlackR_UL'] ?></td>
                                                <td><?= $data['Measurement_Dist_Left_LL'] ?></td>
                                                <td><?= $data['Measurement_Dist_Left'] ?></td>
                                                <td><?= $data['Measurement_Dist_Left_UL'] ?></td>
                                                <td><?= $data['Measurement_Dist_Right_LL'] ?></td>
                                                <td><?= $data['Measurement_Dist_Right'] ?></td>
                                                <td><?= $data['Measurement_Dist_Right_UL'] ?></td>
                                                <td><?= $data['Measurement_Dist_X_LL'] ?></td>
                                                <td><?= $data['Measurement_Dist_X'] ?></td>
                                                <td><?= $data['Measurement_Dist_X_UL'] ?></td>
                                                <td><?= $data['Measurement_Dist_Y_LL'] ?></td>
                                                <td><?= $data['Measurement_Dist_Y'] ?></td>
                                                <td><?= $data['Measurement_Dist_Y_UL'] ?></td>
                                                <td><?= $data['Torque_WithoutLoad_LL'] ?></td>
                                                <td><?= $data['Torque_WithoutLoad'] ?></td>
                                                <td><?= $data['Torque_WithoutLoad_UL'] ?></td>
                                                <td><?= $data['Torque_WithLoad_LL'] ?></td>
                                                <td><?= $data['Torque_WithLoad'] ?></td>
                                                <td><?= $data['Torque_WithLoad_UL'] ?></td>
                                                <td><?= $data['Batch_Oil'] ?></td>
                                            </tr>
                                        </tbody>
